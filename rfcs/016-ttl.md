...
6. TTL compaction priority integrated into the leveled compaction controller:
   ...
   compaction-time visibility model.
...
so TTL entries written by a v9 binary are readable by older binaries (the older
...
raw bytes if they somehow bypass the manifest v5 / SST v9 version checks, though
